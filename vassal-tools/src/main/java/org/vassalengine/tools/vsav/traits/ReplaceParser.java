...
/**
 * Parser for Replace trait.
 * Replace extends PlaceMarker and uses the same format, just with different ID prefix.
 *
 * Type format: replace;commandName;key;markerSpec;markerText;xOffset;yOffset;matchRotation;afterBurnerKey;description;gpId;placement;above;copyDPsByName;parameterList;version
 * State format: (empty)
 */
public class ReplaceParser extends AbstractTraitParser {

    public static final String TRAIT_ID = "replace";
