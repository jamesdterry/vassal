...
/**
 * Parser for Clone trait.
 *
 * Type format: clone;commandName;key;description
 * State format: (empty)
 */
public class CloneParser extends AbstractTraitParser {

    public static final String TRAIT_ID = "clone";
